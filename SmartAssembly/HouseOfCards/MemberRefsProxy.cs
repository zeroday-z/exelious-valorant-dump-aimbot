	...
	public static class MemberRefsProxy
	{
		...
		public unsafe static void CreateMemberRefsDelegates(int typeID)
		{
			...
			*(int*)(nint)/*Error near IL_005a: Stack underflow*/ = 0;
			...
			while (true)
			{
				...
				try
				{
					methodInfo = (MethodInfo)MethodBase.GetMethodFromHandle(System.Runtime.CompilerServices.Unsafe.As<char[], ModuleHandle>(ref MemberRefsProxy._0001).ResolveMethodHandle(*(int*)((byte*)ptr + 4) + 167772161));
				}
				catch
				{
					goto IL_02a7;
		...
		static MemberRefsProxy()
		{
			...
			while (true)
			{
				...
				System.Runtime.CompilerServices.Unsafe.As<char[], _003F>(ref MemberRefsProxy._0001) = /*Error near IL_002d: Stack underflow*/;
				goto IL_002d;
			}
		}
	}
